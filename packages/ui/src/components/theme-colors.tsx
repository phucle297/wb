...
import { COLORS, colorsSchema } from "@wb/common/src/types/colors";
        ...
        <div className="flex-col items-center justify-center space-y-2">
          {COLORS.map((color) => (
            <DropdownMenuItem
              ...
              aria-hidden={true}
              className="flex-center-y border-input bg-background aria-[checked=true]:border-primary flex min-w-[100px] cursor-pointer items-center gap-2 rounded-md border-2 px-2 py-1.5 text-sm font-normal leading-none transition hover:brightness-95 peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
              style={{
                // @ts-ignore
