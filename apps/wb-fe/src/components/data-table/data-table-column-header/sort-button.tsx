    ...
    <TooltipProvider delayDuration={100}>
      <Tooltip>
        <TooltipTrigger {...otherProps} asChild>
          <Icon
            className="text-muted-foreground/70 hover:border-muted-foreground/10 hover:bg-muted hover:text-muted-foreground cursor-pointer rounded-md border border-transparent"
            size={20}
          />
        </TooltipTrigger>
